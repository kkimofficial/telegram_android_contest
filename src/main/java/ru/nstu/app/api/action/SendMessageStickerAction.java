...
public class SendMessageStickerAction extends Action {
    private long dialogId;
    private String path;

    public SendMessageStickerAction(long dialogId, String path) {
    ...
    public void run(Client client) throws Exception {
        client.send(new TdApi.SendMessage(dialogId, new TdApi.InputMessageSticker(path)), new Client.ResultHandler() {
            @Override
