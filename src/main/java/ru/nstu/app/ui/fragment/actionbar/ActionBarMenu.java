...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBarMenuItem addItem(int id, Drawable drawable) {
        return addItem(id, 0, parentActionBar.itemsBackgroundResourceId, drawable, DisplayController.dp(48));
    }
    ...
    public ActionBarMenuItem addItem(int id, int icon, int backgroundResource) {
        return addItem(id, icon, backgroundResource, null, DisplayController.dp(48));
    }
    ...
    public ActionBarMenuItem addItem(int id, int icon, int backgroundResource, Drawable drawable, int width) {
        ...
        ViewController.setTouchAnimation(menuItem, R.color.system_pressed, android.R.color.transparent);
        menuItem.setTag(id);
        if (drawable != null) {
