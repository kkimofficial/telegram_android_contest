...
import ru.nstu.app.ui.fragment.BaseFragment;
...
public class ActionBar extends FrameLayout {
    ...
    public ActionBar(Context context) {
        ...
        titleFrameLayout.setPadding(0, 0, DisplayController.dp(4), 0);
    ...
    private void positionTitle(int width, int height) {
        ...
        if (!DisplayController.isTablet && getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            offset = DisplayController.dp(1);
        }
        int maxTextWidth = 0;
        ...
        if (titleTextView != null && titleTextView.getVisibility() == VISIBLE) {
            if (!DisplayController.isTablet && getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                titleTextView.setTextSize(DisplayController.sp(18));
            } else {
                titleTextView.setTextSize(DisplayController.sp(20));
            }
        ...
        if (subTitleTextView != null && subTitleTextView.getVisibility() == VISIBLE) {
            if (!DisplayController.isTablet && getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
                subTitleTextView.setTextSize(DisplayController.sp(14));
            } else {
                subTitleTextView.setTextSize(DisplayController.sp(16));
            }
        ...
        if (backButtonImageView != null && backButtonImageView.getVisibility() == VISIBLE) {
            x = DisplayController.dp(DisplayController.isTablet ? 80 : 72);
        } else {
            x = DisplayController.dp(DisplayController.isTablet ? 26 : 18);
        }

        if (menu != null) {
            maxTextWidth = Math.min(maxTextWidth, width - menu.getMeasuredWidth() - DisplayController.dp(16) - x);
        }
        ...
        if (titleTextView != null && titleTextView.getVisibility() == VISIBLE) {
            ...
            if (subTitleTextView != null && subTitleTextView.getVisibility() == VISIBLE) {
                ...
                y = (height - titleTextView.getMeasuredHeight()) / 2 - DisplayController.dp(1);
            }
        ...
        layoutParams1.width = x + maxTextWidth + (isSearchFieldVisible ? 0 : DisplayController.dp(6));
        layoutParams1.topMargin = occupyStatusBar ? DisplayController.statusBarHeight : 0;
    ...
    public void positionMenu(int width, int height) {
        ...
        layoutParams.height = height;
        layoutParams.leftMargin = isSearchFieldVisible ? DisplayController.dp(DisplayController.isTablet ? 74 : 66) : 0;
        layoutParams.topMargin = occupyStatusBar ? DisplayController.statusBarHeight : 0;
    ...
    private void createBackButtonImage() {
        ...
        ViewController.setTouchAnimation(backButtonImageView, R.color.system_pressed, android.R.color.transparent);
    ...
    private void createTitleTextView() {
        ...
        titleTextView.setTypeface(DisplayController.typeface());
    }
    ...
    public ActionBarMenu createActionMode() {
        ...
        addView(actionMode);
        actionMode.setPadding(0, occupyStatusBar ? DisplayController.statusBarHeight : 0, 0, 0);
        ...
        if (occupyStatusBar) {
            ...
            layoutParams.height = DisplayController.statusBarHeight;
            layoutParams.width = LayoutParams.FILL_PARENT;
            layoutParams.gravity = Gravity.TOP | Gravity.LEFT;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int actionBarHeight = DisplayController.actionBarHeight;
        ...
        actionBarHeight += occupyStatusBar ? DisplayController.statusBarHeight : 0;
