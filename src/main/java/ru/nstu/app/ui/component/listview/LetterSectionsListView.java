...
package ru.nstu.app.ui.component.listview;
...
import ru.nstu.app.ui.component.adapter.SectionsAdapter;
...
public class LetterSectionsListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (adapter instanceof SectionsAdapter) {
            mAdapter = (SectionsAdapter) adapter;
        } else {
            mAdapter = null;
        }
            ...
            if (a == startSection) {
                ...
                if (pos == count - 1) {
                    ...
                    if (child != null) {
                        ...
                        headerTop = -DisplayController.dp(100);
                    }
                    if (headerTop < 0) {
                ...
                if (child != null) {
                    ...
                    header.setTag(-DisplayController.dp(100));
                }
                itemNum += count;
            }
        }
