...
public class TextSettingsPanel extends FrameLayout {
    ...
    public TextSettingsPanel(Context context) {
        super(context);
        ...
        layoutParams.leftMargin = DisplayController.dp(17);
        layoutParams.rightMargin = DisplayController.dp(17);
        ...
        layoutParams.leftMargin = DisplayController.dp(LocaleController.isRTL ? 17 : 0);
        layoutParams.rightMargin = DisplayController.dp(LocaleController.isRTL ? 0 : 17);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec), DisplayController.dp(48) + (needDivider ? 1 : 0));

        int availableWidth = getMeasuredWidth() - getPaddingLeft() - getPaddingRight() - DisplayController.dp(34);
        ...
        if (valueTextView.getVisibility() == VISIBLE) {
            ...
            width = availableWidth - valueTextView.getMeasuredWidth() - DisplayController.dp(8);
        } else {
